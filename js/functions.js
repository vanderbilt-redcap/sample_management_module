    ...
    $.ajax({
        ...
        if (html != "") {
            ...
            for (const key in resultData) {
                ...
                $('#' + parent_id).html("Part. ID: " + sampleData['participant_id'] + "<br/>Samp. ID: " + sampleData['sample_id'] + "<br/>Sample Type: " + sampleData['planned_type'] + "<br/>Collect Date: " + sampleData['collect_date']+ "<br/><input value='Sample Info' type='button' id='sample_info_" + slot_label + "' onclick='retrieveSampleInfo(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\""+barcode+"\",\""+slot_id+"\",\""+slot_label+"\",\""+input_next+"\");' />");
