    ...
    $.ajax({
        ...
        for (const key in slotList) {
            ...
            if (value['sample_id'] != "") {
                ...
                tableHTML += "<div style='background-color: "+back_color+"' id='sample_slot_" + slotID + "'>" + value['participant_id'] + "<br/>" + value['actual_type'] + "<br/>" + value['collect_date'] + "<br/>" + value['sample_id'] + "<br/><input value='Sample Info' type='button' id='sample_info_" + slotLabel + "' onclick='retrieveSampleInfo(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\""+value['sample_id']+"\",\""+slotID+"\",\""+slotLabel+"\",\"barcode_slot_"+value['project_id'] + "_" + value['record'] + "_" + value['event'] + "_" + (value['instance']+1)+"\");' /><br/><input value='Checkout' type='button' id='sample_checkout_" + slotLabel + "' onclick='checkoutSample(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\""+value['sample_id']+"\",\""+slotID+"\",\""+slotLabel+"\",\"barcode_slot_"+value['project_id'] + "_" + value['record'] + "_" + value['event'] + "_" + (value['instance']+1)+"\");' /></div>";
            } else {
    ...
    $.ajax({
        ...
        if (html != "") {
            ...
            for (const key in resultData) {
                ...
                sampleTable += "<tr><td colspan='2' style='text-align:center;'><input type='button' onclick='saveSample(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\"" + barcode + "\",\"" + slot_id + "\",\"" + slot_label + "\",\"sample_issue_\",\"container_select\");$(\"#sample_info_container\").css(\"display\",\"none\");' value='Save Sample' /></td></tr>";
                $('#' + parent_id).html(sampleData['participant_id'] + "<br/>" + sampleData['planned_type'] + "<br/>" + sampleData['collect_date']+ "<br/>" + sampleData['sample_id'] + "<br/><br/><input value='Sample Info' type='button' id='sample_info_" + slot_label + "' onclick='retrieveSampleInfo(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\""+sampleData['sample_id']+"\",\""+slot_id+"\",\""+slot_label+"\",\"barcode_slot_"+slot_id+"\");' /><br/><input value='Checkout' type='button' id='sample_checkout_" + slot_label + "' onclick='checkoutSample(\""+ajaxurl+"\",\""+project_id+"\",\""+event_id+"\",\""+barcode+"\",\""+slot_id+"\",\""+slot_label+"\",\""+input_next+"\");' />");
